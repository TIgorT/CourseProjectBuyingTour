...
<table>
    ...
    <tbody>
         <tr>
            ...
            <td align="left">Номер карты</td>
            <td align="left">1111 2222 3333 4444</td>
        </tr>
         <tr>
            <td align="center">2</td>
            <td align="left">Месяц</td>
            <td align="left">текущий месяц в формате "ММ"</td>
        </tr>
         <tr>
            <td align="center">3</td>
            <td align="left">Год</td>
            <td align="left">текущий год в формате "YY"</td>
        </tr>
        <tr>
            <td align="center">3</td>
            <td align="left">Владелец</td>
            <td align="left">имя и фамилия латиницей</td>
        </tr>
         <tr>
            <td align="center">4</td>
            <td align="left">CVC/CVV</td>
            <td align="left">три рандомных цифровых символа</td>
        </tr>
 </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td rowspan=6 align="center"> Сообщение "Операция одобрена Банком." и отображение  записи в БД</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td rowspan=6 align="center">Сообщение "Ошибка! Банк отказал в проведении операции. " и отображение  записи в БД</td>
        </tr>
        <tr>
            <td align="center">Заполнить поле "Месяц" валидным значением</td>
        </tr>
        ...
        <tr>
            <td align="center">Заполнить поле "Владелец"  двадцатью двумя буквенными символами включая пробелы</td>
        </tr>
         <tr>
            <td align="center">Заполнить поле "CVC/CVV" валидным значением</td>
        </tr>
        ...
        <tr>
            <td align="center">Заполнить поле "Владелец" именем и фамилией на кириллице</td>
        </tr>
         <tr>
            <td align="center">Заполнить поле "CVC/CVV" валидным значением</td>
        </tr>
        ...
        <tr>
            ...
            <td rowspan=6 align="left">Оплата тура "Путешествие дня" с написанием в поле "Владелец" имени и фамилии латиницей, включая спецсимволы</td>
            <td rowspan=6 align="center">Высокий</td>
            <td rowspan=6 align="center">Запустить SUT и открыть страницу http://localhost:8080</td>
            <td align="center">Ввести в поле "Номер карты" 1111 2222 3333 4444</td>
            <td rowspan=6 align="center">Под полем "Владелец" появится сообщение "Неверный формат"</td>
        ...
        <tr>
            <td align="center">Заполнить поле "Владелец" именем и фамилией латиницей, включая спецсимволы</td>
        </tr>
         <tr>
            <td align="center">Заполнить поле "CVC/CVV" валидным значением</td>
        </tr>
        ...
        <tr>
            ...
            <td rowspan=6 align="left">Оплата тура "Путешествие дня" с написанием в поле "Владелец" имени и фамилии латиницей, включая цифровые символы</td>
            <td rowspan=6 align="center">Высокий</td>
            <td rowspan=6 align="center">Запустить SUT и открыть страницу http://localhost:8080</td>
            <td align="center">Ввести в поле "Номер карты" 1111 2222 3333 4444</td>
            <td rowspan=6 align="center">Под полем "Владелец" появится сообщение "Неверный формат"</td>
        ...
        <tr>
            <td align="center">Заполнить поле "Владелец" имени и фамилии латиницей, включая цифровые символы</td>
        </tr>
         <tr>
            <td align="center">Заполнить поле "CVC/CVV" валидным значением</td>
        </tr>
